...
public class FragmentDetail extends Fragment {
    ...
    private void renderWeather(JSONObject json){
        try{
            ...
            currentTemperatureField.setText("Day:"+String.format("%.2f",temp.getDouble("day"))+"°C"+"Min:"+String.format("%.2f",temp.getDouble("min"))+"°C"+"Max:"+String.format("%.2f",temp.getDouble("max"))+"°C"+"Night:"+String.format("%.2f",temp.getDouble("night"))+"°C"+"Evening:"+String.format("%.2f",temp.getDouble("eve"))+"°C"+"Morning:"+String.format("%.2f",temp.getDouble("morn"))+"°C");

            DateFormat df = DateFormat.getDateTimeInstance();
            String updatedOn = df.format(new Date(details.getLong("dt")*1000));
            updatedField.setText("Last update: "+updatedOn);

            others.setText("Humidity:"+details.getString("humidity")+"%"+"Pressure:"+details.getString("pressure")+"hPa");

            setWeatherIcon(icon);
        }catch(Exception e){
            Log.e("WeatherApp", "Error in Fragment Detail");
        }
    }
